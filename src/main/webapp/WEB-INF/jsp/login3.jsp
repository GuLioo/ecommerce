...
<head>
	...
	<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/resource/css/shop/shop_login.css">
	<!--<link rel="stylesheet" href="css/register.css">-->
	<!--导入jquery-->
	<script src="${pageContext.request.contextPath}/resource/js/jquery-3.3.1.js" type="text/javascript"></script>
	<!--导入布局js，共享header和footer-->
	<script type="text/javascript" src="${pageContext.request.contextPath}/resource/js/include.js"></script>
	<style>
		.sure{
			font-size: 12px;
			color:darkgrey;
