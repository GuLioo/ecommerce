			...
			$("#butAdd").click(function() {
				...
				$(function() {
					$('#imageSub').on('click', function () {
						$.ajax({
							type: "post",
							url: "/ecommerce_war/saler/addProduct.do",
							data: formdata,
							contentType: false,
							processData: false,
							/*dataType: "text",*/
							...
							if ( typeof (FileReader) === 'undefined') {
								...
								try {
									...
									reader.onload = function (e) {
										...
										image.attr('src', "${pageContext.request.contextPath}/resource/images/pic/"+imageName);
				...
				$('#submitAddPro').click(function () {
					...
					$.ajax({
						type: "post",
						url: "/ecommerce_war/saler/addProduct.do",
						data: {"pname": pname,"marketPrice": marketPrice,"pdesc": pdesc,"pnum": pnum},
						dataType: "text",
						success: function (result) {
							console.log(result);
							alert("添加成功");
