...
public class userLoginExecution {
    ...
    public userLoginExecution(String username, userStateEnum stateEnum, adminUser adminUser) {
    ...
    public userLoginExecution(String username, userStateEnum stateEnum) {
        this.username = username;
        this.state = stateEnum.getState();
        this.stateInfo = stateEnum.getInfo();
    }
