...
public interface userBusiness {
    ...
    //执行减库存、增加订单的事务
    ecommerceResult executeSeckill();
    //分页查询获取用户订单信息
     Msg userOrdersInfo(Integer pn, HttpSession session) throws UnsupportedEncodingException;
    //根据pid获取订单详情
    ...
    Msg searchOrdersInfo(@RequestParam(value="pn",defaultValue="1")Integer pn, @DateTimeFormat(pattern="yyyy-MM-dd")Date startTime, @DateTimeFormat(pattern="yyyy-MM-dd")Date endTime, String orderId, HttpSession session) throws UnsupportedEncodingException;
